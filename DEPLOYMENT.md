...
3. [Railway.com Deployment](#railwaycom-deployment)
...
1. **Connect Repository**
   ...
   - Select your FightBot repository
...
### Railway Issues & Solutions

**Port Binding:**
- Railway may have similar port requirements
- Health server handles this automatically

**Environment Variables:**
- Ensure variables are set in Railway dashboard
- Not in railway.toml file (security risk)
