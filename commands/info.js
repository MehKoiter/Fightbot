  ...
  execute: async (interaction) => {
    try {
      const infoEmbed = new EmbedBuilder()
        ...
        .setDescription(
          "Your ultimate UFC companion bot! **Everything is FREE!**"
        )
        .addFields(
          {
          ...
          },
          {
            ...
            value:
              "• **Fighter Profiles** - Detailed stats and records\n" +
          ...
          },
          {
            ...
            value:
              "• **Complete fight card details** - Full event information\n" +
          ...
          },
          {
            ...
            value:
              "1. Use `/fight` to see the next UFC event\n" +
          ...
          },
          {
            ...
            value:
              "FightBot is completely FREE! If you enjoy using it, consider supporting development with `/donate` - but it's totally optional!",
            inline: false,
          }
        )
        .setFooter({
      ...
      try {
        if (!interaction.replied && !interaction.deferred) {
          await interaction.reply({
            content:
              "Sorry, there was an error displaying the information. Please try again later.",
            ephemeral: true,
          });
        }
      } catch (replyError) {
