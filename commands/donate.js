    ...
    async execute(interaction) {
        try {
            ...
            const embed = new EmbedBuilder()
                ...
                .setDescription('FightBot is now completely **FREE** for everyone! All premium features are unlocked.\n\nIf you enjoy using FightBot and want to support its development, consider becoming a patron!')
                .addFields(
                    { name: '🎯 What You Get', value: '✅ **All features are already FREE!**\n• Live betting odds\n• Fight analytics\n• Event notifications\n• Export data\n• Priority support\n\n*No subscription required!*', inline: false },
                    { name: '💖 Support Development', value: 'Your donations help:\n• Keep the bot running 24/7\n• Add new features\n• Improve data accuracy\n• Maintain server costs', inline: false },
                    { name: '🌟 Patreon Benefits', value: '• Early access to new features\n• Direct feedback channel\n• Special donor role\n• Development updates', inline: false }
                )
